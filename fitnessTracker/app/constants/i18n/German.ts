...
export const German = {
  ...
  safe:"Speichern",
  remove:"Löschen",
  workoutDeleteTitle: "Workout löschen?",
  workoutDeleteMessage: "Dieses Workout wird dauerhaft entfernt.",
  sessionDiscardTitle: "Session verwerfen?",
  sessionDiscardMessage: "Diese Trainingseinheit wird nicht gespeichert.",
  ...
  workoutAbortConfirm: "Verlassen",
  workoutAbortCancel: "Abbrechen",
